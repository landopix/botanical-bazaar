...
export default function Success() {
  ...
  return (
    <>
      <Head>
        <title>Order Successful | The Botanical Bazaar</title>
      </Head>
      <div style={{ padding: '6rem 1.5rem', textAlign: 'center', maxWidth: '700px', margin: '0 auto', fontFamily: 'Crimson Text, serif' }}>
        ...
        <p style={{ fontSize: '1.2rem', lineHeight: '1.6', marginBottom: '2.5rem', color: '#F5E7C4' }}>
          We have secured your selected tropical plant companions! Our nursery guides are preparing your collection. We will email or text you shortly to coordinate your personalized local pickup slot or shipping tracking in St. Petersburg, FL.
        </p>
        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
