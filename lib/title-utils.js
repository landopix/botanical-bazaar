 ...
 * Truncates meta description text if it exceeds character limits (strictly max 155 chars).
 */
...
export function formatDescription(rawDescription, defaultDesc = DEFAULT_SITE_DESCRIPTION, limit = 155) {
